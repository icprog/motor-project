 ...
 *                                  Constants
 **************************************************************************/
__root const PROGRAM_ID programId  =
{
   .marker     =  "_FwMk_",         //lint !e784 Upgrade Image marker -- always "_FwMk_"
   .product    =  "MPG Demo",      // Product string
   .productId  =  ((u8)0),       // Product ID from 0 to 255
   .hwVersion  =  (1),       // Current hardware version (1 to 255)
   .fwVersion  =  {0,0,1},       // Current firmware version in Major.Minor.Rev
   .fwMinimum  =  {0,0,0},       // Minimum firmware version to upgrade to this version
   .fwDownMin  =  {0,0,1},  // Minimum firmware version to allow downgrades to
   .buildDate  =  "Mar 17 2014",         // Build date inserted by compiler
   .buildTime  =  "18:12:40",         // Build time inserted by compiler
